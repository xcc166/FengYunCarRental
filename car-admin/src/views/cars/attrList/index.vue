<template>
  <div>
    <CTableData ref="table" :config="table_config">
      <!--车辆公共属性-->
...
<script>
// 组件
import CTableData from "@c/tableData";
import CAddcarAttr from "@c/dialog/addcarAttr";
// API
...
export default {
  ...
  components: { CTableData, CAddcarAttr },
  methods: {
